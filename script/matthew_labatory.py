...
def gen_nums(EngineType, Passengers, Range, BA, EA):
    ...
    engine_dia = 0.5 + (max_takeoff_weight - 15000) * (2.0 - 0.5) / (100000 - 15000)
...
def winnable(EngineType, Passengers, Range):
    ...
    client = genai.Client(api_key="AIzaSyCOdRuZBc36iiGWu-N1wrtwblSXHznEYaY")
    ...
    print(gen_nums(EngineType, Passengers, Range, BA_result, EA_result))

# climb cruise descent
# start and end altitudes of phases

# turbofan turboprop
# 15,000 100,000 [.25,1.25]
winnable("Turbofan", 200.0, 1000000.0)